...
Original file is located at
    https://colab.research.google.com/drive/1qq4mmO7Sw-vd0qsL-1rndeqCeY1xhv1d
...
* Second, download the notebook in .ipynb format (File > Download .ipynb) and upload the .ipynb file to [this form](https://docs.google.com/forms/d/e/1FAIpQLSdD9RqAbZPq9zfXksBcMXzUHDLGUBQPF3pkZnzvtdSZaoBxqg/viewform?usp=sf_link). This homework is due at **11:59pm on Tuesday, 31 May 2022**.
